...
#将input_x转换成为image格式，也就是32,32,3的形式
...
#LRN层local response normalization
...
#池化层2
pool2 = tf.nn.avg_pool(norm2, strides=[1, 2, 2, 1], ksize=[1, 3, 3, 1], padding='SAME')
